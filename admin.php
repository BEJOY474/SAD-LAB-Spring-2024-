...
<body>
                ...
                <div class="card">
                    <div>
                        ...
                        <?php 
                                        ...
                                        echo "<span class='num' data-val='$count' >0</span>" ;
                ...
                <div class="customers">
                    <div class="card-2">
                        ...
                        <div class="card-body">
                            <?php
                                    $conn = new mysqli('localhost','root','','studyabroad');
                                    $sql6 = "SELECT * FROM sign_up";
                                    $result = $conn->query($sql6);
                                  
                                             echo "<table border='1' class = 'table table-success' ;><tr><th>Picture</th><th>Customer Name</th> <th>Phone Number</th>  <th>Email</th> </tr>";
                                             while ( $data = $result->fetch_assoc()) {
                                                $productId = $data['name'];   
                                                $product_name = $data['Phone'];
                                                $email = $data['email'];
                                                $img = $data['img'];

                                                echo "<tr>
                                                        <td><img class='usrimg' src='up_img/$img' alt='No picture'></td>
                                                        <td>$productId</td> 
                                                        <td>$product_name</td> 
                                                        <td>$email</td>  
    ...
    <script>
        document.addEventListener('keydown', function(e) {
            if (e.key === 'PrintScreen' || (e.key === 's' && e.ctrlKey) || (e.key === 'p' && e.ctrlKey) ) {
                e.preventDefault();
