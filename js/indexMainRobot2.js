...
recognition.addEventListener('result', (e) => {
    ...
    if (text.includes('tell me about faculty member of United International University') ||  text.includes('faculty member of United International University')||text.includes('tell me about faculty member of united international university') ||text.includes('tell me about faculty member of United International University') ) {
      p = document.createElement('p');
      p.classList.add('replay');
