                ...
                <div class="col-md-12">
                    <div class="box"> 
                        ...
                        <?php 
                            ...
                            echo  "   <center>" . " <h4> Name:  </h4>  " . $name. "<br>" ." <h4> Email:  </h4>  " 
                                    . $email ."<br>" . " <h4> Phone Number:  </h4>  ".
                                    $Phone.    " <h4> Password:  </h4>  " . $Password ."<br><span class='btn btn-success'><a href='edit.php?id=$user_id'>Update Profile</a></span> <span class='btn btn-success'><a href='changePass.php?id=$user_id'>Change password</a></span>" ."<br>" .  "</center>" ;
